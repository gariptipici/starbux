...
@DataJpaTest
class CustomerInfoReportRepositoryTest {
  ...
  void getTotalAmountPerCustomerTest() {
    ...
    Assertions.assertEquals(BigDecimal.valueOf(TEST_DATA_TOTAL_AMOUNT).toBigInteger(),
        ((BigDecimal) result.get(0)[1]).toBigInteger());
  }
